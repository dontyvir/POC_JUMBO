...
public class PutOutputAddressDTO extends OutputDTO implements Serializable {

	private static final long serialVersionUID = 4945223178629375224L;
 ...
 * */	
	...
	public PutOutputAddressDTO(){}
	
	public PutOutputAddressDTO(String status, String error_message,
			ArrayList addresses) {
		setStatus(status);
