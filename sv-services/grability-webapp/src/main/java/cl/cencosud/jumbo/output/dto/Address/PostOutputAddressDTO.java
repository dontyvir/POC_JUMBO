...
public class PostOutputAddressDTO extends OutputDTO implements Serializable{

	private static final long serialVersionUID = -6744230693486639536L;
	...
	public PostOutputAddressDTO(String status, String error_message,
			ArrayList addresses) {
		setStatus(status);
