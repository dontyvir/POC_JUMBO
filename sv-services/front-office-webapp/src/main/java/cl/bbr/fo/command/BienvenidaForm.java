...
/**
 * Página de bienvenida a los clientes
 * 
 * @author BBR e-commerce & retail
 * 
 */
public class BienvenidaForm extends Command {
	...
	protected void execute(HttpServletRequest arg0, HttpServletResponse arg1)
        ...
        try {            
			...
			//Tracking_web.saveTracking("Bienvenida", arg0);
            ...
            if ( !biz.tieneDireccionesConCobertura(idCliente) ) {
                ...
                String pag_form = rb.getString("conf.dir.html") + "" + getServletConfig().getInitParameter("pag_form_sc");
                ...
                // --- INI - TRACKING OP
                if ( biz.clienteConOPsTracking( idCliente ) ) {
