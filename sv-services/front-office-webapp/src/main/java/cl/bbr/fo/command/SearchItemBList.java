...
/**
 * Página para búsqueda avanzada despliegue
 * 
 * @author BBR e-commerce & retail
 * 
 */
public class SearchItemBList extends Command {
	...
	protected void execute(HttpServletRequest arg0, HttpServletResponse arg1)
		...
		try {
			...
			long marca_id = Long.parseLong(arg0.getParameter("mar_id"));
			...
			List list_prod = biz.getSearchMarca( session.getAttribute("ses_loc_id").toString(), marca_id, cliente_id, orden, list_patrones, l_torec );
