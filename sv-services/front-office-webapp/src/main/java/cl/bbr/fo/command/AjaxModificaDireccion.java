...
/**
 * Modifica una dirección de despacho para un cliente
 *  
 * @author carriagada it4b
 *  
 */
public class AjaxModificaDireccion extends Command {
    ...
    protected void execute(HttpServletRequest arg0, HttpServletResponse arg1) throws CommandException {
        ...
        DireccionesDTO direc = biz.clienteGetDireccion(id_dir);
