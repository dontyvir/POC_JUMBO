 ...
 * 
 */
public class FonoCliRegisterForm extends FonoCommand {
	...
	protected void execute(HttpServletRequest arg0, HttpServletResponse arg1)
		...
		top.setVariable("{send_action}", "FonoCliRegisterNew");
		top.setVariable("{readonly}", "readonly");
		top.setVariable("{Mensaje_clave}", rb.getString("fono.cli.register.form.mensaje.clave"));
		...
		if (arg0.getParameter("fon_cod_1") == null){
			...
			top.setVariable("{selectfono02}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "32"){
			top.setVariable("{selectfono32}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "33"){
			top.setVariable("{selectfono33}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "34"){
			top.setVariable("{selectfono34}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "35"){
			top.setVariable("{selectfono35}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "41"){
			top.setVariable("{selectfono41}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "42"){
			top.setVariable("{selectfono42}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "43"){
			top.setVariable("{selectfono43}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "45"){
			top.setVariable("{selectfono45}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "51"){
			top.setVariable("{selectfono51}", "selected" );				
		}else if (arg0.getParameter("fon_cod_1") == "52"){
			top.setVariable("{selectfono52}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "53"){
			top.setVariable("{selectfono53}", "selected" );				
		}else if (arg0.getParameter("fon_cod_1") == "55"){
			top.setVariable("{selectfono55}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "57"){
			top.setVariable("{selectfono57}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "58"){
			top.setVariable("{selectfono58}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "61"){
			top.setVariable("{selectfono61}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "63"){
			top.setVariable("{selectfono63}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "64"){
			top.setVariable("{selectfono64}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "65"){
			top.setVariable("{selectfono65}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "67"){
			top.setVariable("{selectfono67}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "71"){
			top.setVariable("{selectfono71}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "72"){
			top.setVariable("{selectfono72}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "73"){
			top.setVariable("{selectfono73}", "selected" );
		}else if (arg0.getParameter("fon_cod_1") == "75"){
			top.setVariable("{selectfono75}", "selected" );
		}
		...
		for (int i = 1; i <= 31; i++) {
			...
			if (arg0.getParameter("dia") == null ){
				...
				fila.setVariable("{selectdia}", "selected" );
			}else{
				fila.setVariable("{selectdia}", "" );
			}
		...
		for (int i = 1900; i <= ahora.get(Calendar.YEAR); i++) {
			...
			if (arg0.getParameter("ano") == null ){
				...
				fila.setVariable("{selectano}", "selected" );
			}else{
				fila.setVariable("{selectano}", "" );
			}
		...
		for (int i = 0; i < registros.size(); i++) {
			...
			if (arg0.getParameter("tipo_calle") == null ){
				...
				fila.setVariable("{selectcalle}", "selected" );
			}else{
				fila.setVariable("{selectcalle}", "" );
			}
