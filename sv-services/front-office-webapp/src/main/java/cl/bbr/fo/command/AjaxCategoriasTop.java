 ...
 * 
 */
public class AjaxCategoriasTop extends Command {
	...
	protected void execute(HttpServletRequest arg0, HttpServletResponse arg1)
		...
		try {
			...
			this.getLogger().debug( "[AjaxCategoriasTop - Cabecera] :" + idCabecera + " Intermedia:" + idIntermedia + " Terminal:" + idTerminal );
			...
			this.getLogger().debug("[AjaxCategoriasTop - Categoria] :"+list_categoria.size());
