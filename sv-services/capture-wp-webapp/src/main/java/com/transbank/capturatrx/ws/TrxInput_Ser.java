...
public class TrxInput_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public TrxInput_Ser(
        ...
        throws java.io.IOException
    {
        ...
        javax.xml.namespace.QName propQName;
        {
          ...
          propQName = QName_0_4;
          propValue = new java.lang.Double(bean.getMontoCaptura());
          serializeChild(propQName, null, 
              propValue, 
              QName_1_7,
              true,null,context);
          propQName = QName_0_5;
          propValue = bean.getOrdenPedido();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
