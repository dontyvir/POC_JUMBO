 ...
 *  @version    1.1 (last revision: November 20, 2011)
    ...
    $.Zebra_Accordion = function(el, options) {
        ...
        var init = function() {
            ...
            $(window).bind('resize', function() {
                ...
                $titles.each(function(index) {
                    ...
                    // if we find an opened tab, save the tab's number
                    if ($title.hasClass(plugin.settings.expanded_class)) open = index;
                ...
                // if a tab was open, re-open it now
                if (open !== false) plugin.show(open, true, true);
        ...
        var _get_titles_info = function(nobind) {
            ...
            $titles.each(function(index) {
                ...
                // care in which we don't need to re-attach the function to the required event)
                if (undefined == nobind)
