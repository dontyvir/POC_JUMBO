function ValidaCliente() {
	...
	if (!formulario.dv.value){
		alert('Debes ingresar el dígito verificador del RUT');
		formulario.dv.focus();
		return false;
	}
	...
	if (formulario.sms.checked) {
		if (!formulario.fon_num_2.value) {
			alert('Debes ingresar el campo de Telefono2 (celular)');
			formulario.fon_num_2.focus();
			return false;
		}
	}
