...
public class AgregaSectorPicking extends Command {
	...
	protected void Execute(HttpServletRequest req, HttpServletResponse res, UserDTO usr) throws Exception {
		...
		logger.debug("sector: "+nombre_sector);
		...
		try{
			...
			sector.setId_local(usr.getId_local());
