 ...
 * @author imoyano
 */
public class ViewMonitorRutas extends Command {

	protected void Execute(HttpServletRequest req, HttpServletResponse res, UserDTO usr) throws Exception {
	    logger.debug("Comienzo ViewMonitorRutas Execute");
	    ...
	    RutaCriterioDTO criterio = new RutaCriterioDTO(fechaDespacho, idZona, idChofer, idPatente, idEstado, idRuta, idPedido, clienteRut, clienteApellido, pag, regsperpage, usr.getId_local(), hIni, hFin);
        ...
        List jornadas = biz.getJornadasDespachoParaFiltro(usr.getId_local(), fechaDespacho, idZona);
		...
		logger.debug("Fin ViewMonitorRutas Execute");
