...
public class DetalleParaProductoDeCaso extends Command {
    ...
    protected void Execute(HttpServletRequest req, HttpServletResponse res, UserDTO usr) throws Exception {
        logger.debug("Comienzo DetalleParaProductoDeCaso [AJAX]");
        ...
        logger.debug("Fin DetalleParaProductoDeCaso [AJAX]");
    }
}
