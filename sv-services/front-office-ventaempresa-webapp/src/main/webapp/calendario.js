...
function calendario(a,b,id,field, display){
	var obj = getElmById('PopUpCalendar');
	x = a;
	y = b;
	obj.style.left = x + "px";
	obj.style.top = y + "px";
	...
	getElmById("PopUpCalendar").innerHTML = content;
}
...
{
	var p1, p2 = "";
	//p1 = getElmById(layer) + ".innerHTML = '"+layer+"'; "
	//p2 = value + ".value = ''; "
