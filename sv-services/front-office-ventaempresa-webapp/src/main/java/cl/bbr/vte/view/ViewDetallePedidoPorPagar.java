...
/**
 * Página que muestra el detalle del pedido para que cliente lo pague
 * 
 * @author imoyano
 *  
 */
        ...
        try {
            ...
            if ( arg0.getParameter("id") != null ) {
                ...
                if ( arg0.getParameter("err") != null ) {
                    msgError = "Transacción Fracasada, su transacción no ha podido ser procesada, por favor vuelva a intentarlo, y si el problema persiste comuníquese a su banco emisor.";    
                }
            }
