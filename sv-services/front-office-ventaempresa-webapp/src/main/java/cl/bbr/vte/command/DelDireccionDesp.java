...
/**
 * <p>Comando que elimina una direccion de despacho</p>
 * <p>Como parámetro obligatorio se necesita el identificador único de la dirección de despacho.</p> 
 * 
 * @author BBR e-commerce & retail
 *  
 */
public class DelDireccionDesp extends Command {

	/**
	 * Elimina una direcion de despacho
	 * 
	 * @param arg0
	...
	public void execute(HttpServletRequest arg0, HttpServletResponse arg1)
		...
		try {
			...
			boolean result = biz.delDirDespacho(iddir);
