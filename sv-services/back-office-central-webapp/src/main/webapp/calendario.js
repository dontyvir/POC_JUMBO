...
function generateContent(display){
	...
	table += "<td bgcolor=#009900 align=left valign=top style=\"font-family:tahoma;cursor:move;font-size:7pt;\" >&nbsp;</td>";
	table += "<td bgcolor=#009900 align=right valign=top><a href=\"#\" onclick=\"cerrar('"+tag1+"','"+tag2+"');\" >"+close+"</a></td>";
	table += "</tr></table>";
	...
	//verificando si es a?o ?bisciesto?
