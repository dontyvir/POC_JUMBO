...
/**
 * DelSucComprador Comando Process
 * Elimina la relacion entre comprador y sucursal
 * 
 * @author BBRI
 */

public class DelSucComprador extends Command {
      ...
      */
		...
		//String mensaje_exito = getServletConfig().getInitParameter("mensaje_exito"); 
 		String mensaje_fracaso = getServletConfig().getInitParameter("mensaje_fracaso");
  		...
  		try{
  			result = biz.delRelSucursalComprador(prm);
