...
public class AddCompradorWizard extends Command {
 ...
 protected void Execute(HttpServletRequest req, HttpServletResponse res, UserDTO usr) throws Exception {
     ...
     logger.debug("nº sucursales: " + sucursales.length );
  			 		...
  			 		boolean resultado = false;
  			  		...
  			  		try{
  						...
  						if ( e.getMessage()!= null && !e.getMessage().equals("") ){
  							...
  							logger.debug("Controlando excepción al agregar relacion empresa: " + e.getMessage());
  						}
  			     	}
  				}
	  				...
	  				for (int i=1;i<cant_suc;i++){
	  					...
	  					try{
	  						...
	  						if ( e.getMessage()!= null && !e.getMessage().equals("") ){
	  							...
	  							logger.debug("Controlando excepción con sucursal: " + e.getMessage());
	  						}
	  					}
	  				}
  				}
