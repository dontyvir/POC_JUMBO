...
/**
 * DelEmpComprador Comando Process
 * Elimina la relacion entre comprador y empresa
 * 
 * @author BBRI
 */

public class DelEmpComprador extends Command {
      ...
      */
		...
		//String mensaje_exito = getServletConfig().getInitParameter("mensaje_exito"); 
 		String mensaje_fracaso = getServletConfig().getInitParameter("mensaje_fracaso");
  		...
  		try{
  			result = biz.delRelEmpresaComprador(prm);
