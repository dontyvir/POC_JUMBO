...
/**
 * Cambia estado de la cotizacion a En Revision
 * 
 * @author BBRI
 */

public class CambiaCotEnRevision extends Command {
 ...
 protected void Execute(HttpServletRequest req, HttpServletResponse res, UserDTO usr) throws Exception {
	 ...
	 if (bizDelegate.setModEstadoCotizacion(paramIdCot, Constantes.ID_EST_COTIZACION_EN_REVISION)){
		 //escribe en el log la liberacion
		 String mjeLog = "Cotización ha cambiada a En Revisión.";
