...
public class OfficeDrawingWithGraphics {
    public static void main( String[] args ) throws IOException {
        ...
        // sort them.
        row1.createCell(0).setCellValue(new HSSFRichTextString("C"));
        row2.createCell(0).setCellValue(new HSSFRichTextString("A"));
        row3.createCell(0).setCellValue(new HSSFRichTextString("B"));
