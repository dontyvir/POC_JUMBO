...
public class Logging {
	...
	public Logging( Object obj ) {
        ...
        //PropertyConfigurator.configure("D:/IBM/WorkspaceDESA/DesarrolloLocal/ListenerPOS/src/log4j_app.properties");
		//PropertyConfigurator.configure("C:/Java/eclipse/workspace/BOL/IRS Monitor - Listener/src/log4j_app.properties");
		
		//PRUEBAS CON POS
		//PropertyConfigurator.configure("D:/IBM/WorkspaceDESA/Webpay/ListenerPOS/src/log4j_app.properties");//
