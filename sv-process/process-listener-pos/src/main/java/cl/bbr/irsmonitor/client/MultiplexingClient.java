...
*/
package cl.bbr.irsmonitor.client;
...
import cl.bbr.irsmonitor.handlers.*;
...
//    System.out.println("["+ pc.toString() + "] Packet arrived");
	  ...
	  String in = Utiles.buffer2string(pckt,10);
...
//    System.out.println("[" + pc.toString() + "] Sending packet.");
    //ByteBuffer packet = generateNextPacket(new String("0001DD001050613040506W0017009007DECODIFI123456789012345678"));
	
	  ByteBuffer packetC1 = generateNextPacket(new String("0000770050000000104009311050516401600000001C1000002300100077996901"));
      //ByteBuffer packetC1 = generateNextPacket(new String("0000990010000003149006810120712391800012112C200000940044"));
	  
	  
	  String h1 = "0000990010000003149006810120712391800012112C200000940044";
	  //String d1 = "000000242500100029467000                    ";
	  
	  //ByteBuffer packetC2 = generateNextPacket( h1 );
	  
	  
	packetsSent++;
    pc.sendPacket(packetC1);    
  }
