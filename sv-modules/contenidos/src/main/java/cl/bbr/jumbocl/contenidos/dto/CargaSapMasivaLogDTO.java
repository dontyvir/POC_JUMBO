 ...
 *
 */
public class CargaSapMasivaLogDTO {
	 ...
	 * @param texto
	 */
	public CargaSapMasivaLogDTO(long id , long cod_prod , String fec_crea , String usuario , String texto) {
		super();
		this.id = id;
