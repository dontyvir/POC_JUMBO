 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class MonitorCostosVentaEmpresas extends Thread implements ProcesoInterfaz {
	...
	public MonitorCostosVentaEmpresas(
	 ...
	 * @param target
	 */
	public MonitorCostosVentaEmpresas(Runnable target) {
		super(target);
	 ...
	 * @param target
	 */
	public MonitorCostosVentaEmpresas(ThreadGroup group, Runnable target) {
		super(group, target);
		// Auto-generated constructor stub
	}
	 ...
	 * @param name
	 */
	public MonitorCostosVentaEmpresas(String name) {
		super(name);
		// Auto-generated constructor stub
	}
	 ...
	 * @param name
	 */
	public MonitorCostosVentaEmpresas(ThreadGroup group, String name) {
		super(group, name);
		// Auto-generated constructor stub
	}
	 ...
	 * @param name
	 */
	public MonitorCostosVentaEmpresas(Runnable target, String name) {
		super(target, name);
		// Auto-generated constructor stub
	}
	 ...
	 */
	public void run() {
		setStatus(new Status(1, "Iniciando Monitor Costos Venta Empresas"));
		...
		try {
			if ((locales != null) && (locales.length > 0)) {
				...
				for (int i = 0; i < locales.length; i++)
					filesToMove.addAll(getFileToProcess(SufijosInterfaces.I_COSTOS_VE + locales[i].getCodLocal() + dateToFind + ".*", -1));
				...
				try {
					filesToBackup.addAll(getFileToProcess(SufijosInterfaces.I_COSTOS_VE + ".*", -1));
