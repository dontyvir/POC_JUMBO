...
// Source File Name:   ProcesaReg1Sec.java
...
public class ProcesaReg1Sec extends Feedback
{

    public ProcesaReg1Sec()
    {
    }

    public static FeedbackSeccionDTO procesaReg1(Registro1DTO reg, int id_local)
    {
        ...
        if(reg.getTipoPromo() == 900 || reg.getTipoPromo() == 901 || reg.getTipoPromo() == 902 || reg.getTipoPromo() == 903 || reg.getTipoPromo() == 904 || reg.getTipoPromo() == 905 || reg.getTipoPromo() == 906 || reg.getTipoPromo() == 907 || reg.getTipoPromo() == 908 || reg.getTipoPromo() == 909 || reg.getTipoPromo() == 910 || reg.getTipoPromo() == 911 || reg.getTipoPromo() == 912 || reg.getTipoPromo() == 913 || reg.getTipoPromo() == 914)
        {
        ...
        try
        {
            dao.updinsPromocion(promo);
        }
        catch(IrsPromocionException e)
        {
            return excepSeccion(0, reg.getCodigo(), 5);
        }
        return null;
    }
}