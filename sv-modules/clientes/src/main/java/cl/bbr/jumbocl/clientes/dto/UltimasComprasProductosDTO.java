...
/**
 * DTO para datos de los productos de las últimas compras. 
 * 
 * @author BBR e-commerce & retail
 *
 */
public class UltimasComprasProductosDTO implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2904479280432629413L;
	private long pro_id;
...
//-20120525coh
	 ...
	 * Constructor
	 */
	public UltimasComprasProductosDTO() {
...
/**
 * @return Returns the img_chica.
 */
public String getImg_chica() {
	return img_chica;
}
/**
 * @param img_chica The img_chica to set.
 */
