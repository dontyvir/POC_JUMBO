...
import cl.cencosud.jumbocl.umbrales.dao.DAOFactoryParametros;
...
public class JdbcUmbral  implements UmbralDAO {
	...
	/**
	 * Libera la conexi�n. S�lo si no es una conexi�n �nica, en cuyo caso
	 * no la cierra.
	 * 
	 * 
	 */
	...
	public List getParametrosByCriteria(ElementosCriteriaDTO criterio) throws DAOException, ElementoDAOException {
		...
		//variable del criterio de b�squeda
		//nombre de elemento
	...
	public UmbralDTO getPorcenUmbralById(long id_pedido) throws UmbralesException {
