 ...
 */
package cl.cencosud.jumbocl.umbrales.ctrl;
...
public class UmbralesCtrl {
	...
	public UmbralDTO getPorcenUmbralById(long id_pedido) throws ElementoException, DAOException, UmbralesException{
