...
package cl.bbr.jumbocl.pedidos.switchTBK;
...
import cl.bbr.jumbocl.pedidos.dto.MsgReqDTO;
import cl.bbr.jumbocl.pedidos.dto.MsgRspDTO;
import cl.bbr.jumbocl.pedidos.dto.MsgSwitchDTO;
...
public class ClienteSwitch {
	...
	{	
		...
		try {
		    ...
		    //long monto_trx = ps.getMontoTotalTrxByIdPedido(id_pedido);
	...
	public SocketChannel makeConnection( SocketChannel sc ) {
		try {
			...
			isa = new InetSocketAddress( "172.18.149.156", 4850 );
