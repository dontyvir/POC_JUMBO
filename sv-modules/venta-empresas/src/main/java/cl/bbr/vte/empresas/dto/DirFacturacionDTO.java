...
/**
 * DTO para datos de las direcciones de facturación 
 * 
 * @author BBR e-commerce & retail
 *
 */
public class DirFacturacionDTO implements Serializable{ 
	...
	private String	dfac_fec_crea;
	private long 	dfac_reg_id;
	//nombres
	...
	public long getDfac_reg_id() {
		return dfac_reg_id;
	}
	public void setDfac_reg_id(long dfac_reg_id) {
		this.dfac_reg_id = dfac_reg_id;
	}
	public String getDfac_fec_crea() {
		return dfac_fec_crea;
	}
	public void setDfac_fec_crea(String dfac_fec_crea) {
