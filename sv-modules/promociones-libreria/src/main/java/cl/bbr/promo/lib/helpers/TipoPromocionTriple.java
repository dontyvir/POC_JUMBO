...
// Source File Name:   TipoPromocionTriple.java
...
public interface TipoPromocionTriple
{

    public abstract void initReglaPromocion(PromocionEntity promocionentity, PromocionEntity promocionentity1, PromocionEntity promocionentity2, List list, List list1, List list2);
